...
sample_size <- 1000
df_2 <- swiss_roll(n = sample_size)
df_2 <- df_2 %>% 
  select(-color)

names(df_2) <- c("x1", "x2", "x3")

df_2$x4 <- runif(sample_size, -0.02, 0.02)
df_2$x5 <- runif(sample_size, -0.02, 0.02)
df_2$x6 <- runif(sample_size, -0.1, 0.1)
df_2$x7 <- runif(sample_size, -0.01, 0.01)
df_2$x8 <- runif(sample_size, -0.02, 0.02)
df_2$x9 <- runif(sample_size, -0.1, 0.1)
df_2$x10 <- runif(sample_size, -0.01, 0.01)
```
...
```{r}
pca_out <- calculate_pca(training_data, 4)
...
show_langevitour <- function(df, df_b, df_b_with_center_data, benchmark_value = NA, distance_df, distance_col, min_points_threshold = NA){
