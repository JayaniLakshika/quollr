---
title: "1. Algorithm for binning data"
...
To begin the algorithm, you need to determine the number of bins along the x and y axes to have regular hexagons in the hexagonal grid.
...
Next, you need to perform triangulation on the bin centroids to construct a triangular mesh. 
