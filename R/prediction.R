...
#'
#' @param model_object An object of class \code{hex_model} generated by \code{fit_highd_model()}.
...
#'
#' @export
glance.highd_vis_model <- function(model_object, highd_data, ...) {

  model_2d    <- model_object$model_2d
  model_highd <- model_object$model_highd
...
#'
#' @param model_object An object of class \code{highd_vis_model} containing the model outputs.
...
#'
#' @export
augment.highd_vis_model <- function(model_object, highd_data, ...) {
