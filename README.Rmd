...
[![test](https://github.com/JayaniLakshika/quollr/workflows/test-coverage/badge.svg)](https://github.com/JayaniLakshika/quollr/workflows/test-coverage.yaml)
...
The usage is illustrated with the package's example data, **s_curve_noise**. 
