...
```{r}
data <- readr::read_rds(file = paste0(here::here(), "/data-raw/s_curve_noise.rds"))
training_data <- readr::read_rds(file = paste0(here::here(), "/data-raw/s_curve_noise_training.rds"))
UMAP_data <- readr::read_rds(file = paste0(here::here(), "/data-raw/s_curve_noise_umap.rds"))
```
